...
<body>
	<div>
		...
		<div class="register">
			<h1>POST A JOB</h1>
			<div class = "container">
			<form class ="jobform" method="post" action = "${contextPath}/employeer/postjobsuccess.htm?name=${name}">
                ...
                <br>
            	<label>Location <span class="asterisk">&#42;</span></label><br>
					<select name ="state" id ="job_type_state">
